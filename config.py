...
👇 Жми и заходи:""",
    ...
    "write_value_of_stars_msg": "Пожалуйста напиши кол-во звезд, которое вы хотите вывести.",

    "choose_bank_msg": "Выберите банк, которым вы пользуетесь.",

    "write_correct_value_of_stars": "Введите числовое значение, меньшее вашего баланса в профиле.",

    "write_your_account_number": "Напишите номер карты или телефона, на которые вам переведут деньги.",
}
