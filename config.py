...
TEXTS = {
    ...
    "create_lot_3_msg": "🚀 Укажите цену мгновенного выкупа (блиц-цену).\n"
                        "📌 1🌟 = 1,6₽",
    "create_lot_3.1_msg": "⚠️ Цена должна быть числовым значением, большим нуля.",
    ...
    "send_user_username_msg": "✍ Введите username пользователя (без @), либо id лота (без #):",
    ...
    "end_moderation_blank_msg": "🛑 Вы завершили модерацию заявок.",

    "end_watching_msg": "🛑 Вы завершили просмотр лотов.",

    "end_moderation_dispute_msg": "🛑 Вы завершили модерацию споров.",
...
👇 Жми и заходи:""",
    ...
    "write_value_of_stars_msg": "✨ Пожалуйста, укажите количество звёзд(🌟 = 1.4 руб.), которое вы хотите вывести.",

    "choose_bank_msg": "🏦 Выберите банк, которым вы пользуетесь.",

    "write_correct_value_of_stars": "🔢 Введите числовое значение большее 50, но не превышающее ваш баланс в профиле.",

    "write_your_account_number": "💳 Укажите номер карты или телефона, на которые будет произведён перевод.",

    "withdraw_from_50_stars": "⚠️ Минимальная сумма для вывода — 50 звёзд. На вашем балансе недостаточно звезд.",

    "blank_send_to_administrators": "📨 Ваша заявка на вывод {stars}🌟 ({rub} руб.) отправлена администрации. \n⏳ Обработка занимает до 24 часов в будние дни 🗓️ и до 48 часов в выходные и праздничные дни 🎉.",

    "withdraw_request_admin":   "🧾 Заявка на вывод №<b>{id}</b>\n"
                                "👤 Пользователь: <b>@{user_id}</b>\n"
                                "🏦 Вывод: <b>{bank}</b>\n"
                                "💳 Номер карты / Телефон: <b>{account_number}</b>\n"
                                "💰 Сумма к выводу: <b>{star_amount}</b>🌟 ({rub} руб.)\n"
                                "🕒 Создана: <b>{created_at}</b> (МСК)\n"
                                "{processed_block}",

    "withdraw_request_user":    "🧾 Заявка на вывод №<b>{id}</b>\n"
                                "👤 Пользователь: <b>@{user_id}</b>\n"
                                "🏦 Вывод: <b>{bank}</b>\n"
                                "💳 Номер карты / Телефон: <b>{account_number}</b>\n"
                                "💰 Сумма к выводу: <b>{star_amount}</b> ({rub} руб.)🌟\n",

    "new_withdrawal_notification": "🧾 Поступила новая заявка на вывод средств!",
    "new_lot_notification": "🧾 Поступила новая заявка на создание лота!",
    "new_dispute_notification": "🧾 Открылся новый спор!",

    "dispute_admin": "⚔️ Новый спор №{id}\n"
        "📅 Создан: {created_at}\n"
        "📦 Лот: #{lot_id}\n"
        "🧑‍💼 Продавец: <code>{seller_id}</code>\n"
        "🙋‍♂️ Покупатель: <code>{user_id}</code>\n",
